...
int main() {
    ...
    for (int i = 0; i < 3; i++) { // 세로 크기만큼 반복
        m[i] = malloc(sizeof(int) * 4); // (int의 크기 * 가로 크기)만큼 동적 메모리 할당.
                                        // 배열의 세로
    }
    ...
    printf("%d\n", m[0][0]); // 1: 세로 인덱스 0, 가로 인덱스 0인 요소에 값 출력
    printf("%d\n", m[2][0]); // 5: 세로 인덱스 2, 가로 인덱스 0인 요소에 값 출력
    printf("%d\n", m[2][3]); // 2: 세로 인덱스 3, 가로 인덱스 3인 요소에 값 출력
